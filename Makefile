...
SOURCES       = $(SOURCES_DIR)/camera_daemon.cpp \
		...
		$(SOURCES_DIR)/mainwindow.cpp $(SOURCES_DIR)/moc_mainwindow.cpp \
...
$(TARGET): $(SOURCES_DIR)/ui_mainwindow.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents $(SOURCES_DIR)/camera_daemon.h $(SOURCES_DIR)/high_level_cctv_daemon_apis.h $(SOURCES_DIR)/low_level_cctv_daemon_apis.h $(SOURCES_DIR)/mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents $(SOURCES_DIR)/camera_daemon.cpp $(SOURCES_DIR)/high_level_cctv_daemon_apis.cpp $(SOURCES_DIR)/low_level_cctv_daemon_apis.cpp $(SOURCES_DIR)/main.cpp $(SOURCES_DIR)/mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents $(SOURCES_DIR)/mainwindow.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: $(SOURCES_DIR)/moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) $(SOURCES_DIR)/moc_mainwindow.cpp
$(SOURCES_DIR)/moc_mainwindow.cpp: $(SOURCES_DIR)/high_level_cctv_daemon_apis.h \
		$(SOURCES_DIR)/mainwindow.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/home/konstantin/Documents/programming/SmartCCTV/UI -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include $(SOURCES_DIR)/mainwindow.h -o $(SOURCES_DIR)/moc_mainwindow.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: $(SOURCES_DIR)/ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) $(SOURCES_DIR)/ui_mainwindow.h
$(SOURCES_DIR)/ui_mainwindow.h: $(SOURCES_DIR)/mainwindow.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic $(SOURCES_DIR)/mainwindow.ui -o $(SOURCES_DIR)/ui_mainwindow.h
...
$(OBJECTS_DIR)/mainwindow.o: $(SOURCES_DIR)/mainwindow.cpp $(SOURCES_DIR)/mainwindow.h \
		$(SOURCES_DIR)/ui_mainwindow.h \
		$(SOURCES_DIR)/high_level_cctv_daemon_apis.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o $@ $(SOURCES_DIR)/mainwindow.cpp

$(OBJECTS_DIR)/moc_mainwindow.o: $(SOURCES_DIR)/moc_mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o $@ $(SOURCES_DIR)/moc_mainwindow.cpp
